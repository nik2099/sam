...
export const EmailAddress = 'E-Mail-Adresse';
export const Password = 'Passwort';
export const Otp = 'OTP';
export const Email = 'Email';
export const Confirm_password = 'Confirm Password';
export const NewCampaign = 'Neue Kampagne';
export const Available = 'verfügbar';
export const Still = 'Noch';
export const AllCampaign = 'Alle Kampagnen';
export const ActiveCampaign = 'Aktive Kampagnen';
export const PauseCampaign = 'Pausierte Kampagnen';
export const MyApp = 'Meine Apps';
export const Appstore = 'AppStore';
export const AddApp = 'App hinzufügen';
export const AllApps = 'Alle Apps';
export const MyDevices = 'Meine Geräte';
export const Upgrade = 'Aktualisierung';
export const AllDevice = 'Alle Geräte';
export const Tablet = 'Tablest';
export const WindowsDesktop = 'Windows-Desktop';
export const IosDesktop = 'iOS Desktop';
export const Mobile = 'Handy, Mobiltelefon';
export const Players = 'Player';
export const Downloads = 'Downloads';
export const Desktop = 'Schreibtisch';
export const informEmployee = 'Mitarbeiter informieren';
export const Copy = 'Kopieren';
export const Profil = 'Profil';
export const Optional = 'Optional';
export const PlaceAvailable = 'Plätze verfügbar';
export const Note = 'Notiz';
export const Kindlypress = 'Bitte drücken Sie nach dem Hinzufügen der E-Mail die Eingabetaste';
export const YourTeam = 'Dein Team';
export const InviteEmployees = 'Mitarbeiter einladen';
export const BackToLogin = 'Zurück zum login';
export const RequestNewPassword = 'Neues Passwort anfordern';
export const ForgotPasswors = 'Du hast dein Passwort vergessen?';
export const Forgot = 'Passwort vergessen';
export const Login = 'Login';
export const GetStarted = 'Starte noch heute mit einem kostenlosen Zugang';
export const AllreadyAccount = 'Ich habe bereits einen Account?';
export const StartNow = 'Jetzt starten';
export const deviceMsg = 'Ihr Gerät wird hier angezeigt, nachdem Sie sich bei der Player-App angemeldet haben.';
export const pleaseWait = 'Warten Sie mal...';
export const backToHome = 'Zurück nach Hause';
export const errormsg = 'Die gesuchte Seite wurde nicht gefunden.';
export const allResults = 'Alle Ergebnisse';
export const totals = 'Summe';
export const campaign = 'Kampagne';
export const subUser = 'Benutzer';
export const question = 'Frage';
export const dates = 'Datum';
export const results = 'Ergebnisse';
export const newSubscribe = 'Neue Abonnenten';
export const hourSpendByUser = 'Durchnittliche Sitzungsdauer pro Benutzer';
export const SessionDuration = 'Durchnittliche Sitzungsdauer';
export const last7Days = 'Letzte 7 Tage';
