...
const Preview = ({children , template_name }) => {
  ...
  const [welcomeImage1Url, setWelcomeImage1Url] = useState('/assets/img/image-not-found.png');
  const [welcomeImage2Url, setWelcomeImage2Url] = useState('/assets/img/image-not-found.png');
  const [welcomeImage3Url, setWelcomeImage3Url] = useState('/assets/img/image-not-found.png');
  const [welcomeImage4Url, setWelcomeImage4Url] = useState('/assets/img/image-not-found.png');
  const [welcomeImage5Url, setWelcomeImage5Url] = useState('/assets/img/image-not-found.png');
  const [welcomeImage6Url, setWelcomeImage6Url] = useState('/assets/img/image-not-found.png');
  const [welcomeImage7Url, setWelcomeImage7Url] = useState('/assets/img/image-not-found.png');
  const [welcomeImage8Url, setWelcomeImage8Url] = useState('/assets/img/image-not-found.png');
  ...
  const [productImage1Url, setProductImage1Url] = useState('/assets/img/image-not-found.png');
  const [productImage2Url, setProductImage2Url] = useState('/assets/img/image-not-found.png');
  const [productImage3Url, setProductImage3Url] = useState('/assets/img/image-not-found.png');
  const [productImage4Url, setProductImage4Url] = useState('/assets/img/image-not-found.png');
  ...
  const [product2Image1Url, setProduct2Image1Url] = useState('/assets/img/image-not-found.png');
  const [product2Image2Url, setProduct2Image2Url] = useState('/assets/img/image-not-found.png');
  const [product2Image3Url, setProduct2Image3Url] = useState('/assets/img/image-not-found.png');
  const [product2Image4Url, setProduct2Image4Url] = useState('/assets/img/image-not-found.png');
  ...
  const [product3Image1Description, setProduct3Image1Description] = useState('Die ist ein Typoblindtext. An ihm kann man sehen, ob alle Buchstaben da sind und wie sie aussehen');
  const [product3Image1Url, setProduct3Image1Url] = useState('/assets/img/image-not-found.png');
  const [product3Image2Url, setProduct3Image2Url] = useState('/assets/img/image-not-found.png');
  const [product3Image3Url, setProduct3Image3Url] = useState('/assets/img/image-not-found.png');
  const [product3Image4Url, setProduct3Image4Url] = useState('/assets/img/image-not-found.png');
  ...
  const [product3Image2Description, setProduct3Image2Description] = useState('Die ist ein Typoblindtext. An ihm kann man sehen, ob alle Buchstaben da sind und wie sie aussehen');
  ...
  const [product3Image3Description, setProduct3Image3Description] = useState('Die ist ein Typoblindtext. An ihm kann man sehen, ob alle Buchstaben da sind und wie sie aussehen');
  ...
  const [product3Image4Description, setProduct3Image4Description] = useState('Die ist ein Typoblindtext. An ihm kann man sehen, ob alle Buchstaben da sind und wie sie aussehen');
  ...
  const [product4Image1Description, setProduct4Image1Description] = useState('Die ist ein Typoblindtext. An ihm kann man sehen, ob alle Buchstaben da sind und wie sie aussehen');
  const [product4Image1Url, setProduct4Image1Url] = useState('/assets/img/image-not-found.png');
  const [product4Image2Url, setProduct4Image2Url] = useState('/assets/img/image-not-found.png');
  const [product4Image3Url, setProduct4Image3Url] = useState('/assets/img/image-not-found.png');
  const [product4Image4Url, setProduct4Image4Url] = useState('/assets/img/image-not-found.png');
  ...
  const [product4Image2Description, setProduct4Image2Description] = useState('Die ist ein Typoblindtext. An ihm kann man sehen, ob alle Buchstaben da sind und wie sie aussehen');
  ...
  const [product4Image3Description, setProduct4Image3Description] = useState('Die ist ein Typoblindtext. An ihm kann man sehen, ob alle Buchstaben da sind und wie sie aussehen');
  ...
  const [product4Image4Description, setProduc4Image4Description] = useState('Die ist ein Typoblindtext. An ihm kann man sehen, ob alle Buchstaben da sind und wie sie aussehen');
  ...
  const [galleryImage1Url, setGalleryImage1Url] = useState('/assets/img/image-not-found.png');
  const [galleryImage2Url, setGalleryImage2Url] = useState('/assets/img/image-not-found.png');
  const [galleryImage3Url, setGalleryImage3Url] = useState('/assets/img/image-not-found.png');
  const [galleryImage4Url, setGalleryImage4Url] = useState('/assets/img/image-not-found.png');
  const [galleryImage5Url, setGalleryImage5Url] = useState('/assets/img/image-not-found.png');
  ...
  const [question1Image1Url, setQuestion1firstImage1Url] = useState('/assets/img/image-not-found.png');
  const [question1Image2Url, setQuestion1secondImage2Url] = useState('/assets/img/image-not-found.png');
  const [question1Image3Url, setQuestion1secondImage3Url] = useState('/assets/img/image-not-found.png');
  const [question1Image4Url, setQuestion1secondImage4Url] = useState('/assets/img/image-not-found.png');
  ...
  const [question2Image1Url, setQuestion2firstImage1Url] = useState('/assets/img/image-not-found.png');
  const [question2Image2Url, setQuestion2secondImage2Url] = useState('/assets/img/image-not-found.png');
  const [question2Image3Url, setQuestion2secondImage3Url] = useState('/assets/img/image-not-found.png');
  const [question2Image4Url, setQuestion2secondImage4Url] = useState('/assets/img/image-not-found.png');
  ...
  const [question3Image1Url, setQuestion3firstImage1Url] = useState('/assets/img/image-not-found.png');
  const [question3Image2Url, setQuestion3secondImage2Url] = useState('/assets/img/image-not-found.png');
  const [question3Image3Url, setQuestion3secondImage3Url] = useState('/assets/img/image-not-found.png');
  const [question3Image4Url, setQuestion3secondImage4Url] = useState('/assets/img/image-not-found.png');
  ...
  const fetchCampaignData = async () => {
    ...
    try {
      const responseTemplateData = await app.get(`/getTemplateData/${templatename}`);
      ...
      responseTemplateData.data.forEach(function(ele){
        ...
        if(ele.component == 'navbar'){
          ...
          if(ele.property == 'animation'){
            console.log('animation',ele.value)
  ...
  {/* <Loader /> */}
      ...
      <Head>
        ...
        {template_name == 'dashdock' &&(
           <link rel='stylesheet' href={`/assets/tepmplateComponent/navbar/nav_3.css`} />
        )}

        
        {template_name == 'onares' &&(
           <link rel='stylesheet' href={`/assets/tepmplateComponent/navbar/nav_3.css`} />
        )}
        
        {/* header side bigmenu */}
        {template_name == 'jumbase' &&(
             <link rel='stylesheet' href={`/assets/tepmplateComponent/navbar/big-nav.css`} />
        )}

        {template_name == 'fairpress' &&(
             <link rel='stylesheet' href={`/assets/tepmplateComponent/navbar/big-nav.css`} />
        )}

        {template_name == 'godion' &&(
              <link rel='stylesheet' href={`/assets/tepmplateComponent/navbar/nav_2.css`} />
        )}
      ...
      <div className="container-fluid">
        <div className="row">
            <Eigenschaften3
              ...
              setProduct3Image1SubHeading={setProduct3Image1SubHeading}
              product3Image1Description={product3Image1Description}
              ...
              product3Image2Description={product3Image2Description}
              ...
              product3Image3Description={product3Image3Description}
              image3={product2Image3Url}
              ...
              product3Image4Description={product3Image4Description}
      ...
      <div className="container-fluid">
        <div className="row">
            <Eigenschaften4
              ...
              product4Image1Description={product4Image1Description}
              ...
              product4Image2Description={product4Image2Description}
              ...
              product4Image3Description={product4Image3Description}
              ...
              product4Image4Description={product4Image4Description}
...
export const getServerSideProps = async (context) => {
  const { template_name } = context.params;
  return {
    props: {
      template_name
    },
