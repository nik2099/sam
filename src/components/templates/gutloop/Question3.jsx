...
export default function Question3({ editable, heading, image1, setQuestion3firstImage1Url, setQuestion3firstImage1File, image2, setQuestion3secondImage2Url, setQuestion3secondImage2File, buttonColor, setQuestion3Button1Text, setQuestion3Button2Text,question3Button1Text, question3Button2Text,setQuestion3Heading,setSelectQuestion3Button1,setCurrentPage,currentPage }) {
                            ...
                            <div className="">
                                ...
                                { editable ? (
                                   ...
                                   />
                                    ...
                                    <img src={image1}  onClick={(e) => { clickButton1(question3Button1Text,e); setCurrentPage('kontakt') }} className="gutloop_question_img" alt="" />
                                  )}
                                </div>
                            ...
                            <div className="">
                                ...
                                { editable ? (
                                   ...
                                   />
                                    ...
                                    <img src={image2} onClick={(e) => { clickButton1(question3Button2Text,e); setCurrentPage('kontakt') }} className="gutloop_question_img" alt="" />
                                  )}
                                </div>
