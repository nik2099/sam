                ...
                <div style={{display: 'flex',flexDirection: 'row',gap:'3vw'}}>
                    <div className="image_card">
                        <div className="image" style={{position:'relative'}}>
                            ...
                            />
                                ...
                                <img src={image1}  alt="logo" className="gutloop_welcome_img" style={{width:'100%'}}/>
                    ...
                    <div className="image_card">
                        <div className="image" style={{position:'relative'}}>
                           ...
                           { editable ? (
                            ...
                            />
                                ...
                                <img src={image2}  alt="logo" className="gutloop_welcome_img" style={{width:'100%'}}/>
                            )}
                        ...
                        <div className="full_width_btn">
                            ...
                            { editable ? (
                                <p className="btn" style={{ backgroundColor: buttonColor,color:buttonTextColor,borderRadius:'33px'  }}>
                        ...
                        <div className="image" style={{position:'relative'}}>
                           ...
                           { editable ? (
                            ...
                            />
                                ...
                                <img className="gutloop_welcome_img" src={image3}  alt="logo" style={{width:'100%'}}/>
                            )}
