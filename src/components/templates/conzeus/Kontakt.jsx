...
const Kontak = ({ heading,subheading, setContactHeading,setContactSubHeading,headingColor, background,campaign_id,deviceid,buttonColor, buttonTextColor,buttonHeading,setContactButtonHeading, editable,  template_name,setCurrentPage }) => {
  ...
  const contact = async (e) => {
    ...
    try {
      ...
      const response = await app.post(
        ...
        JSON.stringify({ name, email,campaign_id,deviceid})
      );
            ...
            <div className='flex form contact_background'>
              ...
              { editable ? (
                ...
                />
                    ...
                    <p className='desc_Text kont text-center'>{subheading}</p>
                )}
                </h4>
              </div>
