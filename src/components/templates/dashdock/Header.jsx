...
export default function Header({ editable,progressBarColor,backgroundColor, editorNav, color, notShowable,activeColor, setCurrentPage, currentPage, welcomeMenu,productDetail1Menu,productDetail2Menu,productDetail3Menu,productDetail4Menu,question1Menu,question2Menu,question3Menu,videoMenu,galleryMenu,contactMenu,setWelcomeMenuHeading,setProductDetail1MenuHeading,setProductDetail2MenuHeading,setProductDetail3MenuHeading,setProductDetail4MenuHeading,setQuestion1MenuHeading,setQuestion2MenuHeading,setQuestion3MenuHeading,setVideoMenuHeading,setGalleryMenuHeading,setContactMenuHeading }) {
  ...
  const changeVideoMenuHeading = async (val) => {
    setVideoMenuHeading(val);
  };
                ...
                <div id={editorNav?'nav_4':'nav_3'} className={navopen?'active_menu':''}>
                  ...
                  <li>
                    <a
                      ...
                      id='eigenschaften3'
                      className={currentPage === 'Eigenschaften3' ? 'active' : null}
                      onClick={() => setCurrentPage('Eigenschaften3')}
                    >
                       { editable ? (
                        <EdiText
                            type='textarea'
                            value={productDetail3Menu}
                            onSave={changeProductdetail3MenuHeading}
                            validationMessage="Please type at least 50 characters."
                            validation={val => val.length <= 50}
                            editOnViewClick={true}
                            showButtonsOnHover
                  ...
                  <li>
                    <a
                      ...
                      id='eigenschaften4'
                      className={currentPage === 'Eigenschaften4' ? 'active' : null}
                      onClick={() => setCurrentPage('Eigenschaften4')}
                    >
                       { editable ? (
                        <EdiText
                            type='textarea'
                            value={productDetail4Menu}
                            onSave={changeProductdetail4MenuHeading}
                            validationMessage="Please type at least 50 characters."
                            validation={val => val.length <= 50}
                            editOnViewClick={true}
                            showButtonsOnHover
                  ...
                  <li>
                    <a
                      ...
                      id='video'
                      className={currentPage === 'video' ? 'active' : null}
