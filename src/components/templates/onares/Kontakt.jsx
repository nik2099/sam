...
const Kontak = ({ heading, subheading,setContactHeading,setContactSubHeading,headingColor, background,campaign_id,deviceid,buttonColor, buttonTextColor,editable, buttonHeading,setContactButtonHeading,  template_name,setCurrentPage }) => {
