...
const ColorsComponent = () => {
    ...
    const default_color = ConfigDB.data.color.primary_color || localStorage.getItem('default_color');
    const secondary_color = ConfigDB.data.color.secondary_color || localStorage.getItem('secondary_color');
