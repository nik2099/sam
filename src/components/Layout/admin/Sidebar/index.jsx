...
const SideBarLayout = (props) => {
  ...
  const [currentUrl] = useState(router.pathname);
  ...
  return (
    <Fragment>
      ...
      <header className={`main-nav ${toggleIcon ? 'close_icon' : ''}`}>
        ...
        <SidebarMenu setMainMenu={setMainMenu} props={props} sidebartoogle={true} setNavActive={setNavActive} width={width} user={user}/>
      </header>
    </Fragment>
  );
};
